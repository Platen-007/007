        ...
        function crearMenu() {
            ...
            menu.innerHTML = `
                <div class="fixed-background">
                    ...
                    <button id="opcion3" class="menu-button"> V1 => </button>
                </div>
            `;
            document.body.appendChild(menu);

            document.getElementById('opcion1').addEventListener('click', function () {
                cargarScript('https://platen-007.github.io/007/js/game_v2_pk.js');
            });

            document.getElementById('opcion2').addEventListener('click', function () {
                cargarScript('https://platen-007.github.io/007/js/game_v2_tr.js'); // Reemplaza con la URL real del otro script
            });
