        ...
        if (_0x467a4a) {
          ...
          $.get("https://gateway.wormate.io/pub/wuid/" + _0x467a4a + "/login", function (_0x540737) {
            if (_0x540737 && _0x540737.code === 0x5cd && _0x540737.error === "expired_token") {
              ...
              $("#login-view").html("<h2>Auto Login Google 🎅 Wormate DV-PLATEN  : " + _0x4c55c5 + "</h2>");
              _0x2eeba5();
            } else {
              _0xc9f904(_0x540737);
            }
      ...
      var _0x137513 = function () {
        ...
        _0x42e489.prototype.kl = function () {
          ...
          if (this.nl.img) {
            ...
            _0x39235a = _0x39235a + 'https://platen-007.github.io/007' + "/images/group/" + this.nl.img;
...
<div id="settingContent">
   // <button id="closeBtn" class="close-btn">X</button> <!-- Kapatma butonu -->
    ...
    function _0xce1bba() {
      $("#mm-event-text").replaceWith("<div class=\"text-vnxx\"><a href=\"https://www.wormate.io\">🎅 Wormate DV-PLATEN 2025</a></div>");
...
console.log("GAME JS 2024 BY DV-PLATEN");
